...
public class HeaderServlet extends HttpServlet {
  ...
  protected void service(
    ...
    out.println("</li>");
    out.println("<li class='nav-item active'>");
    out.println("  <a class='nav-link' href='/photoboard/list'>사진 게시판</a>");
    out.println("</li>");
    out.println("</ul>");
    out.println("</div>");
    ...
    if (loginUser == null) {
      out.println("  <a href='/auth/login' class='btn btn-outline-dark bn-sm'>로그인</a>");
    } else {
      out.printf("<a href='/member/detail?no=%d'>%s</a>", 
          loginUser.getNo(),
          loginUser.getName());
      out.println("<a href='/auth/logout' class='btn btn-outline-dark bn-sm'>로그아웃</a>");
    }
    out.println("</div>");
